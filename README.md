...
## BGP Island
### Topology
![BGP_Island](https://github.com/gwill1337/University-Network/blob/main/Images/BGP_Island.png)

## Branch after BGP
### Topology
**3 Layer architecture** provides **modularity** and **scalability**, allowing for easy network expansion and the isolation of technical failures at a single level without disrupting the entire system. Furthermore, it improves **performance** and **manageability**, as each layer is optimized to perform its specific tasks.   
![New_Branch](https://github.com/gwill1337/University-Network/blob/main/Images/New_Branch.png)
### Devices:
